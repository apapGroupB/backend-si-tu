...
//    List<ValueModel> getPengajuanList();
    ...
    @Query(value = "select count(ps.id_jenis_surat) as count, ps.id_jenis_surat, ps.tanggal_pengajuan from pengajuan_surat ps GROUP by ps.id_jenis_surat, ps.tanggal_pengajuan;", nativeQuery = true)
